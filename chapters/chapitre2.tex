...
\'Etonnement, il existe un m\`eme plut\^ot similaire avec un p\`ere
asiatique cette fois : 

{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=1.9335in,height=1.9224in]{chapitre2-img11}
   [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.9004in,height=1.8894in]{chapitre2-img12}
   [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.8449in,height=1.9004in]{chapitre2-img13}
 \par}
...
\begin{itemize}
\item
{\selectlanguage{english}\color[rgb]{0.12156863,0.28627452,0.49019608}
...
Nous observons ici de tr\`es larges et vagues groupes
...
Les trois aspects sont indissociables et forment selon Blackmore un
...
Nous t\^acherons donc ici de d\'efinir le m\`eme comme une s\'erie
...
L{\textquoteright}hypoth\`ese de Ong est ici que
l{\textquoteright}oralit\'e des \'ecritures num\'eriques est une forme
manufactur\'ee de l{\textquoteright}expression orale, \`a laquelle
pr\'eside la production (industrielle) des technologies. Les services
de r\'eseaux sociaux en ligne confirment l{\textquoteright}hypoth\`ese
premi\`ere de Ong puisque \textit{Sina Weibo }ou \textit{Twitter
}contraint l{\textquoteright}\'ecriture \`a une longueur maximum de 140
caract\`eres. N\'eanmoins, l{\textquoteright}oralit\'e du m\`eme
Internet et plus g\'en\'eralement des \'ecritures num\'eriques ne
proc\`ede pas seulement de cette \'ecriture conditionn\'ee mais
\'egalement de la mise en relation des textes :
l{\textquoteright}intertextualit\'e. L\`a o\`u pour Ong
l{\textquoteright}industrie m\'ediatique vient contraindre
l{\textquoteright}\'ecriture pour la r\'eifier en produit industriel
simulant l{\textquoteright}oral, l{\textquoteright}intertextualit\'e
vient subvertir ces limites impos\'ees en renvoyant le lecteur \`a la
page suivante. 
...
\textit{{\textquotedblleft}Expressions have meanings even when they are
...
Le succ\`es de l{\textquoteright}intention de
...
\textcolor[rgb]{0.0,0.0,0.039215688}{En regroupant ces trois
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=3.7894in,height=2.1224in]{chapitre2-img14}
   [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=2.0559in,height=2.0559in]{chapitre2-img15}
 \par}
...
Luttant contres les crabes de rivi\`ere, le \textit{caonima }symbolise
...
\textcolor[rgb]{0.0,0.0,0.039215688}{La popularit\'e des services de
...
\textbf{Marketing politique, soutien, p\'etitions}
...
{\centering\selectlanguage{english}\color{black}
\   [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=4.1669in,height=4.178in]{chapitre2-img16}
...
En Chine \'egalement, les r\'eseaux sociaux sont tr\`es utilis\'es pour
...
Chine int\'erieure.{\textquotedblright}} 
  ...
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=3.3224in,height=2.4335in]{chapitre2-img17}
  

  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.4449in,height=2.178in]{chapitre2-img18}
    [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.4894in,height=2.1894in]{chapitre2-img19}
    [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.2894in,height=2.2224in]{chapitre2-img20}
    [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.3669in,height=2.2114in]{chapitre2-img21}
 

Fig - (en haut) Le tract original - (en bas) Exemples de tracts
...
m\`eme \ qui a \'et\'e extr\^emement diffus\'e. 
  ...
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=6.0114in,height=4.0114in]{chapitre2-img22}
