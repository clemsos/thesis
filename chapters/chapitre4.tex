...
Pour \textit{The Voice} (fig. \ref{fig:words-voice}), nous sommes sans surprise en
...
Dans le cas du congr\`es du parti communiste chinois (fig. \ref{fig:words-ccp}), on retrouve
...
Le m\`eme \textit{dufu} (fig. \ref{fig:dufu-users-pie}) montre quant \`a lui un patterns diff\'erents
