...
\textit{L{\textquoteright}Ordinateur et le Cerveau} \citep{Neumann1948}, Von Neumann
...
energy{\textquotedblright}} \citep{Neumann1948}, p. 155). Utilisant les concepts de
...
dont \textit{The Human Use of Human Beings} \citep{Wiener1988} qui propose
...
champ des \'etudes sur la communication \citep{Breton1997, Winkin1981}.
Quelques ann\'ees plus tard, McLuhan et son id\'ee controvers\'ee de
\textit{village global} \citep{McLuhan1962} am\`enent un large auditoire autour des
...
critique des m\'edias \citep{Mattelart1986, Debray1991} dans une
tradition europ\'eenne d\'ej\`a bien install\'ee \citep{Adorno2005}. Aux Etats-Unis, les \textit{cultural studies }\citep{Hall2003}
...
communicationnel{\textquotedblright} }\citep{Bougnoux1993} n\'ecessite un
...
complexit\'e \citep{Morin1990}. Dans le m\^eme temps, les progr\`es de
...
des organes et des organisations{\textquotedblright} }\citep{Morin1990}
...
ethnographique \citep{Becker1996}. Comme le note justement Latour, la
...
\citep{Latour2003}. Pourtant, il serait illusoire de corr\'eler la
...
possible{\textquotedblright} }\citep{Petit1999}. En construisant un plan
...
repr\'esentation ouvert par la photographie \citep{DidiHuberman2012}.
...
mod\`eles logiques \citep{Harary1977}. Milgram \citep{Travers1969} voit les relations
...
d{\textquoteright}informations importantes \citep{Granovetter1973}.
...
d{\textquoteright}infection{\textquotedblright}} \citep{Cheng2013}
...
de bases \`a des \'etudes pr\'ec\'edentes \citep{Gao2012}. Finalement, nous avons identifi\'e le jeu de donn\'ees
...
d{\textquoteright}un r\'eseau social \citep{Nettleton2013, Robins2013}
...
m\`eme en cours de cr\'eation \citep{Gabora1995}. Dans le contexte des
...
\textit{Force Atlas 2} \citep{Bastian2009} utilisant une
