\chapter{Chapitre 3 : M\'ethodologie de recherche}
...
\section[3.1. Sciences sociales du r\'eseau]{3.1. Sciences sociales du
r\'eseau}
...
\subsection[3.1.1. Le r\'eseau comme enjeu pour
l{\textquoteright}\'etude]{3.1.1. Le r\'eseau comme enjeu pour
l{\textquoteright}\'etude}
...
disciplines scientifiques (Masani, 1990). Depuis le d\'ebut de cette
...
dont \textit{The Human Use of Human Beings} (Wiener, 1954) qui propose
...
aujourd{\textquoteright}hui un enjeu important (Wolton, 1997). En
...
tradition europ\'eenne d\'ej\`a bien install\'ee (Adorno \& Horkeihmer,
1944). Aux Etats-Unis, les \textit{cultural studies }(Hall, 1970)
...
communicationnel{\textquotedblright} }(Bougnoux, 1998) n\'ecessite un
...
complexit\'e (Morin, 2005). Dans le m\^eme temps, les progr\`es de
...
nouveaux \^etres (Hofstadter, 1999). Le mod\`ele du \textit{r\'eseau
...
des organes et des organisations{\textquotedblright} }(Morin, 2005)

\subsection[3.1.2. Code, donn\'ees et les nouveaux outils de
l{\textquoteright}\'ecriture scientifique ]{3.1.2. Code, donn\'ees et
les nouveaux outils de l{\textquoteright}\'ecriture scientifique }
...
l{\textquoteright}exp\'erience (James, 1912)\textit{.
...
%\includegraphics[width=5.0559in,height=3.7894in]{chapitre3-img1}
 \par}

{\centering
\textit{Fig. Triptyque des pratiques scientifiques,
d{\textquoteright}apr\`es Guichard (2013)}
\par}
...
ethnographique (Becker, 1974). Comme le note justement Latour, la
...
(Latour, 2010). Pourtant, il serait illusoire de corr\'eler la
...
et sociales (Wieviorka, 2013). L{\textquoteright}appareillage projet\'e
...
intellectuel{\textquotedblright} }(Guichard, 2014) passe par une lente
...
pens\'ee.{\textquotedblright}} (Jacob, 2011) 
...
du volume des corpus trait\'es (Breiman, 2001). Le domaine de
...
}(Somers, 2013). Comme le note Douglas Hofstadter, un des pairs de
...
chessboard?{\textquotedblright} }(Somers, 2013). 
...
rapide expansion (Nettleton, 2013). Pourtant, le d\'ebat sur la
...
\subsection[3.1.3 Visualisation~et espace perceptif pour
l{\textquoteright}information]{3.1.3 Visualisation~et espace perceptif
pour l{\textquoteright}information}
...
donn\'ees (Cairo, 2013). D\'efinie comme \textit{{\guillemotleft}~a
...
1997). Dans son travail, Engelhardt (2007) s{\textquoteright}attache
...
profonds de l{\textquoteright}\'epoque (Raynaud, 2005). Au-del\`a
...
repr\'esentation (Damisch, 1999). Empreinte de rationalit\'e, la
...
possible{\textquotedblright} }(Petit, 1996). En construisant un plan
...
repr\'esentation ouvert par la photographie (Didi-Huberman, 2012).
...
connaissance (Ware, 2004). Dans sa s\'emiologie graphique, Bertin
...
signal.}{\textquotedblright} (Manovich, 2013). Ce formatage nouveau de
...
pour la production un sens (Eco, 1985). La \textit{citizen science} ou
...
effectuant des t\^aches simples (Silvertown, 2009). Le projet
...
r\'ealisation d{\textquoteright}un mod\`ele 3D (Seung, 2012). Utilisant
...
\section[3.2. M\'ethodes et outils d{\textquoteright}analyse des
r\'eseaux sociaux]{3.2. M\'ethodes et outils d{\textquoteright}analyse
...
\subsection[3.2.1. Anatomie d{\textquoteright}un r\'eseau social]{3.2.1.
Anatomie d{\textquoteright}un r\'eseau social}
...
\textit{gestalt }durant les ann\'ees 1920-1930 (Scott, 1988)\textit{.
...
mod\`eles logiques (Harary, 1977). Milgram (1969) voit les relations
...
(Nettleton, 2013). Si cette structure point-ligne semble toutefois
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=4.178in,height=4.1449in]{chapitre3-img2}
 \par}

{\centering
Fig. - Un graphe de r\'eseau. 
\par}
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=3.8004in,height=3.6894in]{chapitre3-img3}
 \par}

{\centering
Fig. Un r\'eseau social multi-couches, d{\textquoteright}apr\`es
\ (Brodka\&al., 2013)
\par}
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=6.3449in,height=2.0224in]{chapitre3-img4}
 \par}

{\centering
Fig. Types communs de r\'eseaux
\par}
...
est inscrit dans la structure du r\'eseau social lui-m\^eme (Lin, 1999)
et n{\textquoteright}a pas de relations avec le degr\'e du node (son
nombre de connections) (Cha et al., 2010). L{\textquoteright}individu
...
\subsection[3.2.2. Diffusion des discours dans les r\'eseaux
sociaux]{3.2.2. Diffusion des discours dans les r\'eseaux sociaux}
...
situation spatiale du lieu et ses \'equipements (Crevoisier, 2004). Les
...
technologique (Howells, 2002). Cette vision doit \^etre mod\'er\'ee par
...
d{\textquoteright}infection{\textquotedblright}} (Cheng et al., 2013)
...
r\'ef\'erentes (Cha et al., 2010). D{\textquoteright}autres
...
relations de pouvoirs (Steyer et al., 2006)\textit{. }Les dynamiques
...
\subsection[3.2.3. M\'ethodes d{\textquoteright}analyse de donn\'ees des
r\'eseaux sociaux en ligne]{3.2.3. M\'ethodes d{\textquoteright}analyse
de donn\'ees des r\'eseaux sociaux en ligne}
...
statistiques (Rothenberg, 1995), les algorithmes de \textit{crawling}
...
structurelle des conversations (Karandikar, 2010).
...
personnes, etc. &
A mi-chemin entre linguistique et informatique (Russel, 2011), ce champ
est un des grands enjeux actuels du Big Data (Nettleton, 2013) avec
...
Huberman, 2005) et de la politique (Lotan et al., 2011), 

ce type d{\textquoteright}analyse cherche \`a comprendre et retracer les
processus parfois psychologiques (Robins, 2013) de prise de d\'ecisions
individuelle.\\
6 &
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=4.6894in,height=2.6114in]{chapitre3-img5}
 \par}

{\centering
\textit{Fig. Le sch\'ema de Jakobson (1960) }offre une grille de lecture
int\'eressante que nous pouvons chercher \`a adapter dans le contexte
des \'echanges en ligne. 
\par}
...
\section{3.3. Design de la recherche : M\'ethodologie choisie et schemes
d{\textquoteright}analyse retenus}
\subsection[3.3.1. Constitution et collection d{\textquoteright}un
corpus de donn\'ees]{3.3.1. Constitution et collection
d{\textquoteright}un corpus de donn\'ees}
...
(Ko, 2010). Pour entrer en contact avec la base de donn\'ees, les SNS
...
(Clifton, 2006). Ces conditions sont susceptibles de changer. Ainsi,
...
parfois (McCreadie, 2012). Actuellement, Twitter pr\'ecise notamment
...
qu{\textquoteright}il fait des donn\'ees (Rieder, 2005) 
\end{itemize}
...
vers ses voisins{\textquotedblright}} (Rothenberg, 1995). Ici, deux
...
fait de mani\`ere al\'eatoire (Gjoka, 2011). 
...
\begin{figure}
    ...
    \end{tabular}
    \caption[Structure des donn\'ees du jeu de donn\'ees Weiboscope]{Structure des donn\'ees dans le jeu de donn\'ees Weiboscope, d{\textquoteright}apr\`es Fu \& Chau (2013)}
\end{figure}
...
\subsection[3.3.2. Identification des m\`emes en tant que
{\textquotedblleft}clusters{\textquotedblright}]{3.3.2. Identification
des m\`emes en tant que
{\textquotedblleft}clusters{\textquotedblright}}
...
lui-m\^eme (Ienco, 2010). Plus marginal, des \'etudes
...
}(Breiman, 2001)\textit{. }La multitude d{\textquoteright}algorithmes
...
m\`eme en cours de cr\'eation (Gabora, 1997). Dans le contexte des
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=5.8894in,height=1.2114in]{chapitre3-img6}
 \par}

{\centering
\textit{Fig - Algorithme de {\textquotedbl}meme
clustering{\textquotedbl} d{\textquoteright}apr\`es Ferrara (2013)}
\par}
...
science informatique (Salton, 1975), il s{\textquoteright}agit de
...
est utilis\'e (Soucy, 2005). Les autres mesures de similarit\'e sont la
...
(Ferrara, 2013). Cette matrice de valeurs de similarit\'e nous permet
...
\subsection[3.3.3. L{\textquoteright}identification des m\`emes par
hashtags ]{3.3.3. L{\textquoteright}identification des m\`emes par
hashtags }
...
curation de contenu (Buckingham, 2006). Les \textit{hashtags }(en
...
une d\'enotation ou connotation du message original (Romero, 2011) ou
...
est un sujet de recherche encore tr\`es discut\'e (Qiu, 2013).
...
\begin{figure}
    ...
    \subfloat[Volume de tweets pendant la semaine ]{
        % \includegraphics[width=3.2004in,height=3.2004in]{chapitre3-img7}
    }
...
%\includegraphics[width=6.0114in,height=3.2114in]{chapitre3-img8}
 

{\centering
\textit{Fig. 2. Distribution des 429 hashtags s\'electionn\'es }
\par}
...
sur Sina Weibo depuis plusieurs anne\'es (Ng, 2013). En comparant cette
...
\subsection[3.3.4. Visualisation du graphe conversationnel
d{\textquoteright}utilisateurs]{3.3.4. Visualisation du graphe
conversationnel d{\textquoteright}utilisateurs}
...
\begin{figure}
  [Warning: Image ignored] % Unhandled or unsupported graphics:
    %\includegraphics[width=6.2894in,height=3.0004in]{chapitre3-img9}
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=5.5669in,height=4.4224in]{chapitre3-img10}
 \par}
...
\textit{{\textquotedblleft}}\textit{Nodes represent Twitter users, and
directed edges represent retweeted posts that carry the meme. The
brightness of a node indicates the activity (number of retweets) of a
user, and the weight of an edge reflects the number of retweets between
two users. \newline
(a) The }\textbf{\textit{\#Japan}}\textit{ meme shows how news about the
March 2011 earthquake propagated. \newline
(b) The }\textbf{\textit{\#GOP}}\textit{ tag stands for the US
Republican Party and as many political memes, displays a strong
polarization between people with opposing views. \newline
Memes related to the Arab Spring and in particular the 2011 uprisings in
(c) }\textbf{\textit{\#Egypt}}\textit{ and (d)
}\textbf{\textit{\#Syria}}\textit{ display characteristic hub users and
strong connections, respectively.{\textquotedblright}}



{\centering
Fig. Texte et figures d{\textquoteright}apr\`es Weng \& al, 2012
\par}
...
{\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=5.5894in,height=5.4224in]{chapitre3-img11}
 \par}



\textit{Fig. Visualisation simple du hashtag
{\textquotedblleft}WeicoPlus{\textquotedblright}, un trait repr\'esente
un \'echange entre deux utilisateurs}
...
{\centering
WeicoPlus   [Warning: Image ignored]
% Unhandled or unsupported graphics:
%\includegraphics[width=5.0449in,height=3.1559in]{chapitre3-img12}
 
\par}

{\centering
\textit{Fig. Visualisation simple du hashtag }{\textquotedblleft}Veuve
d{\textquoteright}enfant
unique{\textquotedblright}[FF08?][5931?][72EC?][6BCD?][4EB2?][FF09?]
\par}
...
\subsection[3.3.5. Premiers \'el\'ements d{\textquoteright}analyse:
visualisation de m\`emes ]{3.3.5. Premiers \'el\'ements
d{\textquoteright}analyse: visualisation de m\`emes }
...
\centering
    \subfloat[Pluie torrentielle \`a Tianjing]{
        [Warning: Image ignored] % Unhandled or unsupported graphics:
        %\includegraphics[width=2.3224in,height=1.4449in]{chapitre3-img13}  
    }

    \subfloat[Veuve \`a l{\textquoteright}enfant unique]{
        %\includegraphics[width=2.3004in,height=1.7224in]{chapitre3-img14}
    }


    \subfloat[Abolition des lois sur la prostitution]{
        %\includegraphics[width=2.1449in,height=1.9224in]{chapitre3-img15}    
    }
...
Gephi (Bastian, 2013) afin d{\textquoteright}examiner de plus pr\`es la
...
21 au 22 Juillet 2012. 
  ...
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=6.0114in,height=3.7894in]{chapitre3-img16}
 

\textit{Downpour bypasses Beijing, batters neighbor, }in Qinghua News le
2012-07-26 13:29:59,
\url{http://news.xinhuanet.com/english/china/2012-07/26/c_131740415.htm}
consult\'e le 27 Juin 2014.
...
de la relayer.
  ...
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=6.0114in,height=6.0114in]{chapitre3-img17}
 

{\centering
\textit{Fig. Exemple 1 : Tianjin Baoyu}
\par}
...
{\centering
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=6.0114in,height=6.0114in]{chapitre3-img18}
 Fig. \textit{{\textquotedblleft}Shidu Muqin{\textquotedblright}}
\par}
...
activit\'e intense.
  ...
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=6.0114in,height=6.0114in]{chapitre3-img19}
 

{\centering
\textit{Fig. {\textquotedblleft}Piaowudong nuzui{\textquotedblright}}
\par}
...
\section{3.4. M\'ethodologie de traitement et de visualisation des
m\`emes}
...
font souvent le succ\`es (Bauckhage, 2011).
...
\section[3.4.1. S\'election de m\`emes pour
l{\textquoteright}\'etude]{\textmd{\textup{3.4.1. S\'election de
...
s\'electionn\'es al\'eatoirement).
  ...
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=6.0004in,height=5.078in]{chapitre3-img20}
 

Fig. Ce tableau de bord permet de comparer la qualit\'e de diff\'erentes
requ\^etes dans le corpus
...
\section{3.4.2. Extraction des graphes et traitement des donn\'ees
brutes}
...
\textbf{3.4.2.1. Graphe langagi\`ere (langagier ?)}
...
\textbf{3.4.2.3. Localisation des utilisateurs}
...
\section{3.4.3. Visualisation multi-graphes}
...
\textbf{3.4.3.1. Choix technologiques}
...
\textbf{3.4.3.2. Espace perceptif, plan projectif et choix
...
\textbf{3.4.3.3. Graphes et interactions}
...
graphes. (Bostock \& al., 2011)
  ...
  [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=6.7213in,height=8.3894in]{chapitre3-img21}
